          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
            <div className="space-y-3 max-w-3xl">
              <h1 className="text-3xl sm:text-4xl font-bold text-(--color-primary)">
                Build a simple routine for speaking, reading, and writing
                Tigrinya
              </h1>
              <p className="text-(--color-text-muted) text-base sm:text-lg leading-relaxed">
                ...
                prompts, quick phrases, and links to tools already in this
                workspace.
              </p>
              <div
      ...
      <section className="rounded-2xl border border-[rgba(17,24,39,0.06)] bg-white p-5 sm:p-6 shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
          <div>
            ...
            <p className="text-sm text-(--color-text-muted)">
              Say each line three times: first read, then from memory, then
              record yourself.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="rounded-xl border border-[rgba(17,24,39,0.06)] p-4 bg-(--color-secondary)">
            ...
            <p className="text-sm text-(--color-text-dark) leading-relaxed">
              Pick a 20–30 second clip (radio, YouTube, family voice note). Play
              it three times, repeating after each pause. Note one new word and
          ...
          <div className="rounded-xl border border-[rgba(17,24,39,0.06)] p-4 bg-(--color-secondary)">
            ...
            <p className="text-sm text-(--color-text-dark) leading-relaxed">
              Describe your day in four sentences, then rewrite each one
              shorter. Check spelling and word order with the dictionary and
              your own ear.
            </p>
          </div>
        </div>
